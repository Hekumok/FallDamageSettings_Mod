...
public @interface Hook {
    ...
    /**
     * Позволяет установить значение локальной переменной тем значением, что вернет хук-метод.
     * Тип переменной берется из возвращаемого типа хука.
     */
    int setLocalVar() default -1;
